...
#define PUBLISH_INTERVAL 10000  // Publish data each minute to MQTT broker
#define MANUAL_INTERVAL 30000  // Manual function check interval will be on each 15 min
